            ...
            <div className="bg-base-200 text-base-content flex flex-col justify-between min-h-screen">
                ...
                <nav className=" navbar justify-between shadow-md bg-primary">
                    ...
                    <div>
                        ...
                        <div className="flex items-center justify-center border-2 aspect-square rounded-full text-primary-content ">User</div>
                    </div>
...
const NavMenu = (prop: INavMenu) => (
    <Link href={prop.href} className="btn btn-ghost text-primary-content btn-sm">{prop.children}</Link>
)
...
const Brand = (prop: IBrand) => (
    <Link href="" className="btn btn-ghost text-primary-content text-xl">{prop.children}</Link>
)