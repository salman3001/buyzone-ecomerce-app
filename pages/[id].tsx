        ...
        <Layout title="product-name">
            <div className="flex-grow container mx-auto grid sm:grid-cols-3 gap-8 p-4  ">
                ...
                <div className="flex flex-col gap-2">
                    ...
                    <p>Price : 200 $</p>
                    <p>Lorem ipsum, dolor sit amet consectetur adipisicing elit. Aliquid animi corrupti impedit iure dolores nihil quod itaque quaerat temporibus perspiciatis!</p>
